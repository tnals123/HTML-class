...
<body class = "body">
    <main class="resistersection">
        <form method="post" name="resister">
            ...
            <p class="idpw_section">
                <input type="text" class="idpw" placeholder="취미를 입력하세요" name="hobby">
            </p>
            <p class="idpw_section">
                <input type="text" class="idpw" placeholder="연락처를 입력하세요" name="phonenumber">
            </p>
            <p class="checkbox_section">
                <label class="labelsection">남</label><input type="radio" value = "man" class="choice" name="office">
                <label class="labelsection">여</label><input type="radio" value = "woman" class="choice" name="office">
            </p>
